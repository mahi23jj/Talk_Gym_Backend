...
Revision ID: b9537a13952f
Revises: 569437776e60
Create Date: 2026-04-06 08:21:32.934604
...
revision: str = 'b9537a13952f'
down_revision: Union[str, Sequence[str], None] = '569437776e60'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('attempt_id', sa.Integer(), nullable=False),
    sa.Column('training_type', training_mode_enum, nullable=False),
    sa.Column('transcript', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['attempt_id'], ['attempts.id'], ),
    sa.PrimaryKeyConstraint('id')
