...
#         limits = RedisTokenBucketRateLimiter._get_limits_by_tier(
#             user_tier,
#             minute_limit,
#             hour_limit,
#         )
...
#             retry_after = RedisTokenBucketRateLimiter._calculate_retry_after(
#                 minute_remaining,
#                 limits['minute'],
#             )
...
#     @staticmethod
#     def _get_limits_by_tier(tier: str, default_minute: int, default_hour: int) -> Dict:
#         multipliers = {
#             "free": 1.0,
#             "premium": 3.0,
#             "enterprise": 10.0
...
#     @staticmethod
#     def _calculate_retry_after(remaining_tokens: int, limit: int) -> int:
